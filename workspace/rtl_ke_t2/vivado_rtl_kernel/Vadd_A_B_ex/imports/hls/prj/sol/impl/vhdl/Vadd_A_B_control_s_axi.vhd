...
entity Vadd_A_B_control_s_axi is
generic (
...
end entity Vadd_A_B_control_s_axi;
...
architecture behave of Vadd_A_B_control_s_axi is
    ...
    constant ADDR_SCALAR00_DATA_0 : INTEGER := 16#10#;
    constant ADDR_SCALAR00_CTRL   : INTEGER := 16#14#;
    ...
    signal int_scalar00        : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_SCALAR00_DATA_0 =>
                        rdata_data <= RESIZE(int_scalar00(31 downto 0), 32);
                    when ADDR_A_DATA_0 =>
...
-- ----------------------- Register logic ----------------
    ...
    scalar00             <= STD_LOGIC_VECTOR(int_scalar00);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_SCALAR00_DATA_0) then
                    int_scalar00(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_scalar00(31 downto 0));
                end if;
            end if;
        end if;
    end process;
