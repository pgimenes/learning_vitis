...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xilinx_vip -L xpm -L axi_infrastructure_v1_1_0 -L xil_defaultlib -L axi_vip_v1_1_6 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot slv_m00_axi_vip xil_defaultlib.slv_m00_axi_vip xil_defaultlib.glbl -log elaborate.log
}
